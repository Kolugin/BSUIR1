...
namespace MyCourceProject
{
    public partial class Form2 : Form
    {
        public string ConnectSTR;
        private OleDbConnection dbCon;
        public Form2(string FIO, string Spec, string Otdel, string Datatest, string NameTest, string TypeTest, string ConnectSTR)
        {
            InitializeComponent();
            this.FIO = FIO;
            this.Spec = Spec;
        ...
        {
            if (FIO != "" && Spec != "" && Otdel != "" && Datatest != "" && PravOtvet != "" && ChtoOtvetil != "" && TypeTest != "")
            {
                dbCon = new OleDbConnection(ConnectSTR);
                dbCon.Open();
                using (dbCon)
                {
                    string Query = "INSERT INTO Registry (FIO, Speciality, Otdel, DataTest, NameTest, Typetest, Quest, PravOtvet, ChtoOtvetil) VALUES (@FIO, @Speciality, @Otdel, @DataTest, @NameTest, @TypeTest, @Quest, @PravOtvet, @ChtoOtvetil)";
                    ...
                    com.Parameters.AddWithValue("@DataTest", Datatest);
                    com.Parameters.AddWithValue("@NameTest", NameTest);
        ...
        {
            if (Type == 1 && TypeTest == "Тренировка") // первый тип вопроса
            {
            ...
            if (Type == 2 && TypeTest == "Тренировка") // 2 тип вопрсоа
            {
        ...
        public void Integra() // метод присваивания значения в зависимости от i
        {
        ...
        public void Reader() // метод чтения теста
        {
            ...
            {
                // чтение вопросов
                OleDbCommand cmd = new OleDbCommand("SELECT Q FROM " + Convert.ToString(NameTest), dbCon);
                ...
                reader.Close();
                // чтение типа вопроса
                OleDbCommand cmd2 = new OleDbCommand("SELECT TQ FROM " + Convert.ToString(NameTest), dbCon);
                ...
                reader2.Close();
                // чтение ответа1
                OleDbCommand cmd3 = new OleDbCommand("SELECT A1 FROM " + Convert.ToString(NameTest), dbCon);
                ...
                reader3.Close();
                // чтение ответа2
                OleDbCommand cmd4 = new OleDbCommand("SELECT A2 FROM " + Convert.ToString(NameTest), dbCon);
                ...
                reader4.Close();
                // чтение ответа3
                OleDbCommand cmd5 = new OleDbCommand("SELECT A3 FROM " + Convert.ToString(NameTest), dbCon);
                ...
                reader5.Close();
                // чтение ответа4
                OleDbCommand cmd6 = new OleDbCommand("SELECT A4 FROM " + Convert.ToString(NameTest), dbCon);
                ...
                reader6.Close();
                // чтение ответа5
                OleDbCommand cmd7 = new OleDbCommand("SELECT A5 FROM " + Convert.ToString(NameTest), dbCon);
                ...
                reader7.Close();
                // чтение ответа6
                OleDbCommand cmd8 = new OleDbCommand("SELECT A6 FROM " + Convert.ToString(NameTest), dbCon);
                ...
                reader8.Close();
                // чтение ответа7
                OleDbCommand cmd9 = new OleDbCommand("SELECT A7 FROM " + Convert.ToString(NameTest), dbCon);
                ...
                reader9.Close();
                // чтение ответа8
                OleDbCommand cmd10 = new OleDbCommand("SELECT A8 FROM " + Convert.ToString(NameTest), dbCon);
                ...
                reader10.Close();
                // чтение ответа9
                OleDbCommand cmd11 = new OleDbCommand("SELECT A9 FROM " + Convert.ToString(NameTest), dbCon);
                ...
                reader11.Close();
                // чтение ответа10
                OleDbCommand cmd12 = new OleDbCommand("SELECT A10 FROM " + Convert.ToString(NameTest), dbCon);
                ...
                OleDbCommand cmd13 = new OleDbCommand("SELECT PA1 FROM " + Convert.ToString(NameTest), dbCon);
                ...
                OleDbCommand cmd14 = new OleDbCommand("SELECT PA2 FROM " + Convert.ToString(NameTest), dbCon);
                ...
                OleDbCommand cmd15 = new OleDbCommand("SELECT PA3 FROM " + Convert.ToString(NameTest), dbCon);
                ...
                OleDbCommand cmd16 = new OleDbCommand("SELECT PA4 FROM " + Convert.ToString(NameTest), dbCon);
                ...
                OleDbCommand cmd17 = new OleDbCommand("SELECT PA5 FROM " + Convert.ToString(NameTest), dbCon);
                ...
                OleDbCommand cmd18 = new OleDbCommand("SELECT KPA FROM " + Convert.ToString(NameTest), dbCon);
        ...
        public void Finish() //Дейтсвие при окончании теста
        {
            SbrosVisibl();
            SbrosCheck();
            Quests.Clear();
        ...
        public void Test()//метод для прохождения теста
        {
            Integra();
            VernOtvet();
            CheckNull();
        ...
        private void button2_Click(object sender, EventArgs e) // Тест
        {
            //TypeTests();
            button2.Text = "Далее";
            button2.Image = MyCourseProject.Properties.Resources.forward;
            if (i == 0)
            {
                Test();
            }
