...
namespace MyCourseProject
{
    public partial class Form6 : Form
    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                if (textBox1.Text == "1")
                                {
                                        ...
                                        textBox13.Text != "" && textBox14.Text != "")
                                    {
                                        if (textBox19.Text != "" && checkBox15.Checked == false)
                                        {
                                            ...
                                            if (textBox19.Text != "" && textBox18.Text != "" && textBox17.Text != "" && textBox16.Text != "" && textBox15.Text != "")
                                            {
                                                ...
                                                {
                                                    if (textBox5.Text != "NONE" && textBox6.Text != "NONE" && textBox7.Text != "NONE" && textBox8.Text != "NONE")
                                                    {
                                                    ...
                                                    {
                                                        MessageBox.Show("Как минимум один из 4 первых вариантов ответов равен NONE.", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                                        return;
                                                    }
                                    ...
                                    {
                                        MessageBox.Show("Вы не ввели один из вариантов ответов. Введите в пустое поле вариант ответа либо NONE", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                        return;
                                    }
                                }
                                if (textBox1.Text == "2")
                                        ...
                                        textBox13.Text != "" && textBox14.Text != "")
                                            {
                                                ...
                                                if (textBox19.Text == "NONE" || textBox19.Text == "NONE")
                                                {
                                                    MessageBox.Show("Правильный ответ не может равнятся NONE либо NONE.", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                                    textBox19.Text = "";
                                                    return;
                                                }
                                            }
                                        ...
                                        textBox13.Text != "" && textBox14.Text != "")
                                            {
                                                ...
                                                if ((textBox19.Text == "NONE" || textBox19.Text == "NONE") || (textBox18.Text == "NONE" || textBox18.Text == "NONE"))
                                                {
                                                    MessageBox.Show("Правильный ответ не может равнятся NONE либо NONE.", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                        ...
                                        textBox13.Text != "" && textBox14.Text != "")
                                            {
                                                ...
                                                if ((textBox19.Text == "NONE" || textBox19.Text == "NONE") ||
                                                    (textBox18.Text == "NONE" || textBox18.Text == "NONE") ||
                                                    (textBox17.Text == "NONE" || textBox17.Text == "NONE"))
                                                {
                                                    MessageBox.Show("Правильный ответ не может равнятся NONE либо NONE.", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                        ...
                                        textBox13.Text != "" && textBox14.Text != "")
                                            {
                                                ...
                                                if ((textBox19.Text == "NONE" || textBox19.Text == "NONE") ||
                                                    (textBox18.Text == "NONE" || textBox18.Text == "NONE") ||
                                                    (textBox17.Text == "NONE" || textBox17.Text == "NONE") ||
                                                    (textBox16.Text == "NONE" || textBox16.Text == "NONE"))
                                                {
                                                    MessageBox.Show("Правильный ответ не может равнятся NONE либо NONE.", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                                    textBox19.Text = ""; textBox18.Text = ""; textBox17.Text = "";
                                                    return;
                                        ...
                                        textBox13.Text != "" && textBox14.Text != "")
                                            {
                                                ...
                                                if ((textBox19.Text == "NONE" || textBox19.Text == "NONE") ||
                                                    ...
                                                    (textBox17.Text == "NONE" || textBox17.Text == "NONE") ||
                                                    (textBox16.Text == "NONE" || textBox16.Text == "NONE") ||
                                                    (textBox15.Text == "NONE" || textBox15.Text == "NONE"))
                                                {
                                                    MessageBox.Show("Правильный ответ не может равнятся NONE либо NONE.", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                                    textBox19.Text = ""; textBox18.Text = ""; textBox17.Text = "";
                                                    return;
                                ...
                                if (textBox1.Text == "3")
                                {
                                    ...
                                    {
                                        MessageBox.Show("Вы не отметили все поля вариантов ответов как NONE. Отметъте все поля как NONE", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                        return;
                                    }
                                }
                            }
        ...
        private void button2_Click(object sender, EventArgs e) //Верно 1
        {
            if (textBox1.Text == "1")
            {
                if (textBox19.Text == "" && checkBox15.Checked == false)
